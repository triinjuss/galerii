export default {
    template: `
    	<a-entity static-body>
            ...
            <a-plane position="0 0.5 0" scale="1 0.2 1" shadow="recieve: true" material="color: white; side: double"  width="10" height="5" class="wall1"></a-plane>
            <a-plane position="0 4.5 0" scale="1 0.2 1" shadow="recieve: true" material="color: white; side: double"  width="10" height="5" class="wall2"></a-plane>
